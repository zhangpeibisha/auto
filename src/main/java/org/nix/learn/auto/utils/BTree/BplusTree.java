package org.nix.learn.auto.utils.BTree;
...
/**
 * @author zhangpei341@pingan.cn.com 2018/9/18 下午2:56
 * @version 1.0
 */
...
//		 testOrderRemove(size, order);
        ...
        bplusTree.insertOrUpdate("zhangpei","bisha");
        System.out.println(bplusTree.get("zhangpei"));
    }
